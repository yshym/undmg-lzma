...
size_t dummyRead(AbstractFile *file, void *data, size_t len) { return 0; }
...
off_t dummyTell(AbstractFile *file) { return *((off_t *)(file->data)); }

void dummyClose(AbstractFile *file) { free(file); }
